$(function(){
  ...
  var p1_porcentajePatrones = p1_totalPatrones * 100 / 8;
  ...
  var p2_porcentajePatrones = p2_totalPatrones * 100 / 8;
  ...
  var batallometro = (parseFloat(p1_total) + parseFloat(p2_total)) * 100 / 32;
