$(function(){
  ...
  //TYPED JS
  var options = {
    strings: ["Tienes 12 compases para votar a c/u","Las reglas las pones tú...", "Comienza...", "&larr; &larr; &larr;"],
    typeSpeed: 75,
    showCursor: false,
    smartBackspace: true
  }
  ...
  function tomarDatos(){
    ...
    var p1_patron12 = parseFloat($("#patron12p1").val());
    ...
    var p2_patron12 = parseFloat($("#patron12p2").val());
    ...
    p1_totalPatrones = p1_patron1 + p1_patron2 + p1_patron3 + p1_patron4 + p1_patron5 + p1_patron6 + p1_patron7 + p1_patron8 + p1_patron9 + p1_patron10 + p1_patron11 + p1_patron12;
    p2_totalPatrones = p2_patron1 + p2_patron2 + p2_patron3 + p2_patron4 + p2_patron5 + p2_patron6 + p2_patron7 + p2_patron8 + p2_patron9 + p2_patron10 + p2_patron11 + p2_patron12;
  ...
  $("#btn-terminar").click(function(e){
     ...
     .then((willDelete) => {
       if (willDelete) {
         ...
         $(location).attr('href', 'resultados12p.html');
       } else {
         e.preventDefault();
